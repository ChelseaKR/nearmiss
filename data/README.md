...
- `fars-YYYY-state-mode.json` is one canonical, closed state × involved-mode artifact. Every one of
...
- `fars-state-mode-index.json` is the canonical allowlist of released years. Each entry pins the
