...
> methodology TL;DR), and **R29/R34** (per-city threshold-sensitivity +
> "how many reports until rankable" power notes, generated by
> `tools/sensitivity_note.py` and published as
