...
> methodology TL;DR), **R48** (the reporting-bias audit surfaced as a visible
> web panel, driven by a privacy-safe `bias` metadata block), and **R29/R34**
> (per-city threshold-sensitivity + "how many reports until rankable" power
> notes, generated by `tools/sensitivity_note.py` and published as
> [`<city>-sensitivity.md`](../../data/published/davis-sensitivity.md)). The gated big-ticket **R40–R44 / E13–E16** (contributor
...
- **R29 — Snapping/dedup threshold transparency + sensitivity note** per city. · P06,P15 · M · P1 · HR5 · **✓ shipped** (`tools/sensitivity_note.py` → `data/published/<city>-sensitivity.md`; METHODOLOGY.md §5.6)
...
- **R34 — Power/"how many reports until rankable" note** per the small-n gate. · P12,P05 · M · P2 · HR2 · **✓ shipped** (power note in `data/published/<city>-sensitivity.md`; METHODOLOGY.md §5.6)
