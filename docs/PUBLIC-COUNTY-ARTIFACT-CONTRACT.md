...
matching pinned Census boundary shard. The builder rejects any detached digest,
year or source mismatch, crosswalk/boundary identity mismatch, or county cell
without a boundary feature.
...
county codes, case identifiers, private feasibility digests, and private
projection digests.
