...
| **SBOM generation** | **Exercised.** The release workflow builds a CycloneDX 1.7 SBOM and attaches it to the release. `sbom.cdx.json` is published on the v0.2.0, v0.3.0, and v0.3.1 releases (2026-08-08), each with a Sigstore bundle, so there is a published SBOM to verify. |
