...
| Local doc links resolve | pass | 443 relative links checked in 90 Markdown files; 0 unresolved |
...
| --- | ---: | --- |
| Hand-authored docs | 94 | Markdown at the repository root and under `docs/`, `data/`, `infra/`, `notebooks/`, `schema/`, `src/`, `tests/`, `web/`, plus the root legal and template files |
