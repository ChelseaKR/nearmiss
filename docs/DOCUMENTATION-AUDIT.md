...
| Local doc links resolve | pass | 480 relative links checked in 95 Markdown files; 0 unresolved |
...
| --- | ---: | --- |
| Hand-authored docs | 99 | Markdown at the repository root and under `docs/`, `data/`, `infra/`, `notebooks/`, `schema/`, `src/`, `tests/`, `web/`, plus the root legal and template files |
| Test files | 110 | `tests/test_*.py` |
