...
| Performance | Applies | The city-scale benchmark and current baseline are documented in [`docs/PERFORMANCE.md`](docs/PERFORMANCE.md) and run through `make bench`; a merge-blocking regression budget remains open in [`docs/ROADMAP.md`](docs/ROADMAP.md). |
