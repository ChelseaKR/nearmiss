...
_COVERAGE_IDS: tuple[str, ...] = (
    ...
    N_("web.coverage.advanced_view_label"),
    N_("web.coverage.advanced_views"),
    ...
    N_("web.coverage.brief_verification_copy"),
    N_("web.coverage.brief_verification_h"),
    N_("web.coverage.brief_verification_label"),
    N_("web.coverage.build_dossier"),
    ...
    N_("web.coverage.citation_boundary"),
    N_("web.coverage.citation_copied"),
    N_("web.coverage.copy_citation"),
    N_("web.coverage.county_next_action"),
    N_("web.coverage.county_next_copy"),
    N_("web.coverage.county_next_h"),
    N_("web.coverage.county_next_kicker"),
    N_("web.coverage.dossier_requires_evidence"),
